...
import com.weatherknow.android.logic.dao.PlaceDao
import com.weatherknow.android.logic.model.Place
import com.weatherknow.android.logic.model.Weather
    ...
    fun refreshWeather(lng: String, lat: String) = fire(Dispatchers.IO) {
        coroutineScope {
            val deferredRealtime = async {
                WeatherKnowNetwork.getRealtimeWeather(lng, lat)
            }
            val deferredDaily = async {
                WeatherKnowNetwork.getDailyWeather(lng, lat)
            }
